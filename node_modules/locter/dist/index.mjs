...
function getModuleExport(data, filterFn) {
    ...
    if (// eslint-disable-next-line no-underscore-dangle
    typeof data.__esModule !== 'undefined' && typeof data.default !== 'undefined') {
        return {
            key: 'default',
            value: data.default
        };
...
export { ConfLoader, JSONLoader, LoaderManager, ModuleLoader, buildFilePath, buildFilePathWithoutExtension, buildLocatorOptions, getFileNameExtension, getModuleExport, handleException, hasOwnProperty, hasStringProperty, isFilePath, isJestRuntimeEnvironment, isLocatorInfo, isObject, isSafeObjectKey, isTsNodeRuntimeEnvironment, load, loadSync, locate, locateMany, locateManySync, locateSync, pathToLocatorInfo, registerLoader, removeFileNameExtension, toArray };
