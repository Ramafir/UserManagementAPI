...
function removeFieldInputOperator(field) {
    ...
    return firstCharacter === exports.FieldOperator.INCLUDE || firstCharacter === exports.FieldOperator.EXCLUDE ? field.substring(1) : field;
}
function transformFieldsInput(fields) {
    ...
    for(let i = 0; i < fields.length; i++){
        ...
        if (operator) {
            ...
            switch(operator){
                case exports.FieldOperator.INCLUDE:
                    {
                        output.included.push(fields[i]);
                        break;
                    }
                case exports.FieldOperator.EXCLUDE:
                    {
